...
export const IconCloud = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className={className}>
     <path d="M17.5,19c-3.037,0-5.5-2.463-5.5-5.5c0-1.472,0.584-2.812,1.528-3.824C12.919,6.726,10.686,4.5,8,4.5c-3.037,0-5.5,2.463-5.5,5.5c0,0.474,0.063,0.932,0.177,1.371C1.076,12.223,0,13.974,0,16c0,2.761,2.239,5,5,5h12.5c2.485,0,4.5-2.015,4.5-4.5S19.985,12,17.5,12c-0.23,0-0.45,0.021-0.662,0.057C17.279,12.693,17.5,13.332,17.5,14c0,2.761,2.239,5,5,5h12.5c2.485,0,4.5-2.015,4.5-4.5S19.985,12,17.5,12L17.5,19z" />
  </svg>
);
...
export const IconMusic = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const IconHeadphones = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
// --- NEW CUTE ICONS FOR STICKERS ---

export const IconCat = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M12 2c.6 0 1.2.1 1.7.2.2-1.3 1.4-2.2 2.7-2.2 1.5 0 2.7 1.2 2.7 2.7 0 .3-.1.6-.2.9.5-.1 1.1-.2 1.7-.2 3.8 0 6.9 2.7 7.4 6.3l.1.7c0 4.1-3.4 7.4-7.5 7.4-.6 0-1.2-.1-1.7-.2-.2 1.3-1.4 2.2-2.7 2.2-1.5 0-2.7-1.2-2.7-2.7 0-.3.1-.6.2-.9-.5.1-1.1.2-1.7.2-4.1 0-7.5-3.4-7.5-7.5 0-.2 0-.5.1-.7C5.1 4.7 8.2 2 12 2zM9 9c0-.6-.4-1-1-1s-1 .4-1 1 .4 1 1 1 1-.4 1-1zm7 0c0-.6-.4-1-1-1s-1 .4-1 1 .4 1 1 1 1-.4 1-1z"/>
  </svg>
);
...
export const IconPlant = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 22v-9"></path>
    <path d="M12 13a5 5 0 0 0-5-5c0-3 3-5 5-6 2 1 5 3 5 6a5 5 0 0 0-5 5Z"></path>
    <path d="M7 22h10"></path>
  </svg>
);

export const IconRainbow = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
